...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.mathologic.projects.mongo.elasticsearch.repositories")
...
@PropertySource(value = "classpath:config/elasticsearch.yml")
